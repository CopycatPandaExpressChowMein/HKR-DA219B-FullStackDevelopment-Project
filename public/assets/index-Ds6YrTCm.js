...
var l = o((e) => {
		...
		function oe(e, t, n) {
			...
			var r = [],
				i = 0;
			return ae(e, r, ``, ``, (e) => t.call(n, e, i++)), r;
		}
		function se(e) {
			if (e._status === -1) {
				var t = e._result;
		...
		(e.Activity = f),
			...
			(e.unstable_useCacheRefresh = () => C.H.useCacheRefresh()),
			(e.use = (e) => C.H.use(e)),
			(e.useActionState = (e, t, n) => C.H.useActionState(e, t, n)),
			(e.useCallback = (e, t) => C.H.useCallback(e, t)),
			(e.useContext = (e) => C.H.useContext(e)),
			(e.useDebugValue = () => {}),
			(e.useDeferredValue = (e, t) => C.H.useDeferredValue(e, t)),
			(e.useEffect = (e, t) => C.H.useEffect(e, t)),
			(e.useEffectEvent = (e) => C.H.useEffectEvent(e)),
			(e.useId = () => C.H.useId()),
			(e.useImperativeHandle = (e, t, n) => C.H.useImperativeHandle(e, t, n)),
			(e.useInsertionEffect = (e, t) => C.H.useInsertionEffect(e, t)),
			(e.useLayoutEffect = (e, t) => C.H.useLayoutEffect(e, t)),
			(e.useMemo = (e, t) => C.H.useMemo(e, t)),
			(e.useOptimistic = (e, t) => C.H.useOptimistic(e, t)),
			(e.useReducer = (e, t, n) => C.H.useReducer(e, t, n)),
			(e.useRef = (e) => C.H.useRef(e)),
			(e.useState = (e) => C.H.useState(e)),
			(e.useSyncExternalStore = (e, t, n) => C.H.useSyncExternalStore(e, t, n)),
			(e.useTransition = () => C.H.useTransition()),
			(e.version = `19.2.6`);
	}),
	u = o((e, t) => {
		t.exports = l();
	...
	h = o((e) => {
		...
		function oe(e) {
			...
			if (typeof e == `object`)
				switch (e.$$typeof) {
					...
					case E:
						return (
							(t = e.displayName || null), t === null ? oe(e.type) || `Memo` : t
						);
					case D:
		...
		function be(e) {
			me.current === e && (fe(pe), fe(me)),
				ge.current === e && (fe(ge), (Qf._currentValue = ce));
		}
		var xe, Se;
		function Ce(e) {
			if (xe === void 0)
...
` +
		...
		var Wt = /[\n"\\]/g;
		function Gt(e) {
			return e.replace(Wt, (e) => `\\` + e.charCodeAt(0).toString(16) + ` `);
		}
					...
					!Object.hasOwn(n, r) ||
						...
						(r.indexOf(`--`) === 0
							...
							: r === `float`
								...
								: (e[r] = ``));
				for (var a in t)
					(r = t[a]), Object.hasOwn(t, a) && n[a] !== r && en(e, a, r);
			} else for (var o in t) Object.hasOwn(t, o) && en(e, o, t[o]);
		}
		function nn(e) {
				...
				movementX: (e) =>
					`movementX` in e
						...
						: (e !== Nn &&
								...
								(Nn = e)),
							jn),
				movementY: (e) => (`movementY` in e ? e.movementY : Mn),
			}),
			Fn = En(Pn),
		...
		var Kn = En(
				h({}, kn, {
					...
					locale: 0,
					getModifierState: Gn,
					charCode: (e) => (e.type === `keypress` ? Cn(e) : 0),
					keyCode: (e) =>
			...
			M = En(h({}, Dn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
			Yn = En(
				h({}, Pn, {
					deltaX: (e) =>
			...
			Xn = En(h({}, Dn, { newState: 0, oldState: 0 })),
			Zn = [9, 13, 27, 32],
			Qn = gn && `CompositionEvent` in window,
			$n = null;
		gn && `documentMode` in document && ($n = document.documentMode);
		var er = gn && `TextEvent` in window && !$n,
			tr = gn && (!Qn || ($n && 8 < $n && 11 >= $n)),
			nr = ` `,
			rr = !1;
		function ir(e, t) {
		...
		var Fr = gn && `documentMode` in document && 11 >= document.documentMode,
			Ir = null,
			Lr = null,
			Rr = null,
			zr = !1;
		...
		function Gr(e) {
			...
			var t = Hr[e],
				n;
			for (n in t) if (Object.hasOwn(t, n) && n in Wr) return (Ur[e] = t[n]);
			return e;
		}
		...
		function vi(e, t, n, r, a, o) {
			...
			if (((r = e), typeof e == `function`)) hi(e) && (s = 1);
				...
				a: switch (e) {
					case te:
						return (
							(e = mi(31, n, t, a)), (e.elementType = te), (e.lanes = o), e
						);
					case y:
					...
					case x:
						return (
							(e = mi(12, n, t, a | 2)), (e.elementType = x), (e.lanes = o), e
						);
					case w:
						return (e = mi(13, n, t, a)), (e.elementType = w), (e.lanes = o), e;
					case T:
				...
				for (d = r(d); h < s.length; h++)
					(g = m(d, i, h, s[h], c)),
						g !== null &&
							...
							(u = g));
				return e && d.forEach((e) => t(i, e)), P && Pi(i, h), l;
			}
			function g(a, s, c, l) {
				...
				for (h = r(h); !v.done; g++, v = c.next())
					(v = m(h, a, g, v.value, l)),
						v !== null &&
							...
							d === null ? (u = v) : (d.sibling = v),
							(d = v));
				return e && h.forEach((e) => t(a, e)), P && Pi(a, g), u;
			}
			function b(e, r, o, c) {
				if (
					(typeof o == `object` &&
		...
		function Do(e) {
			...
			e === null ||
				V ||
				((e = e.dependencies), e !== null && ia(e) && (V = !0));
		}
		function Oo(e, t, n, r) {
			I = e;
			var a = 0;
		...
		function Fo(e) {
			...
			return (
				...
				(R === null ? t.memoizedState : R.next) === null &&
					((t = t.alternate),
					(O.H = t === null || t.memoizedState === null ? Hs : Us)),
				e
			);
		}
		function Io(e) {
		...
		function Bo(e, t, n) {
			...
			if (((o = e.baseState), a === null)) e.memoizedState = o;
				...
				if (
					(l === null ? (s = o) : (l.next = c),
					!Or(o, e.memoizedState) && ((V = !0), d && ((n = va), n !== null)))
				)
					throw n;
				(e.memoizedState = o),
					(e.baseState = s),
		...
		function Ts(e, t, n, r, i) {
			...
			try {
				...
				Is(e, t, { then: () => {}, status: `rejected`, reason: n }, pu());
			} finally {
				(k.p = a),
		...
		function Ds(e, t, n, r) {
			...
			var a = Os(e).queue;
			Ts(e, a, t, ce, n === null ? Es : () => (ks(e), n(r)));
		}
		function Os(e) {
			var t = e.memoizedState;
			if (t !== null) return t;
		...
		function Ps(e, t, n) {
			...
			(n = {
				...
				Rs(e)
					? zs(t, n)
					: ((n = ci(e, t, n, r)), n !== null && (hu(n, e, r), Bs(n, t, r)));
		}
		function Fs(e, t, n) {
			Is(e, t, n, pu());
		}
		...
		var Hs = {
				...
				use: Io,
				useCallback: (e, t) => (
					(No().memoizedState = [e, t === void 0 ? null : t]), e
				),
				useContext: oa,
				useEffect: fs,
				...
				useLayoutEffect: (e, t) => us(4194308, 4, e, t),
				...
				useDebugValue: bs,
				useDeferredValue: (e, t) => Cs(No(), e, t),
				useTransition: () => {
					var e = Jo(!1);
					return (
				...
				useMemoCache: Lo,
				useCacheRefresh: () => (No().memoizedState = Ns.bind(null, I)),
				useEffectEvent: (e) => {
					var t = No(),
						n = { impl: e };
					return (
			...
			Us = {
				...
				useState: () => zo(Ro),
				useDebugValue: bs,
				useDeferredValue: (e, t) => ws(B(), L.memoizedState, e, t),
				useTransition: () => {
					var e = zo(Ro)[0],
						t = B().memoizedState;
		...
		function sc(e, t, n, r, i) {
			...
			return (
				...
				e !== null && !V
					? (jo(e, t, i), jc(e, t, i))
					: (P && s && Ii(t), (t.flags |= 1), oc(e, t, r, i), t.child)
			);
		}
		...
		function hc(e, t, n) {
			...
			if (o !== null) {
				...
				if ((fo(t), a))
					...
					(V || ra(e, t, n, !1), (a = (n & e.childLanes) !== 0), V || a)
				) {
					if (
						((r = K),
						r !== null && ((s = ct(r, n)), s !== 0 && s !== o.retryLane))
					)
						throw ((o.retryLane = s), li(e, s), hu(r, e, s), ac);
					Du(), (t = mc(e, t, n));
				} else
					(e = o.treeContext),
						(N = cf(s.nextSibling)),
		...
		function _c(e, t, n, r, i) {
			return (
				...
				e !== null && !V
					? (jo(e, t, i), jc(e, t, i))
					: (P && r && Ii(t), (t.flags |= 1), oc(e, t, n, i), t.child)
			);
		}
		function vc(e, t, n, r, i, a) {
			return (
				...
				e !== null && !V
					? (jo(e, t, a), jc(e, t, a))
					: (P && r && Ii(t), (t.flags |= 1), oc(e, t, n, a), t.child)
			);
		}
		...
		function wc(e, t, n) {
			...
			if (l !== null && ((c = l.dehydrated), c !== null)) {
				if (o)
					...
					(V || ra(e, t, n, !1), (s = (n & e.childLanes) !== 0), V || s)
				) {
					if (
						((s = K),
						s !== null && ((r = ct(s, n)), r !== 0 && r !== l.retryLane))
					)
						throw ((l.retryLane = r), li(e, r), hu(s, e, r), ac);
					af(c) || Du(), (t = Dc(e, t, n));
				} else
					af(c)
			...
			switch ((Li(t), t.tag)) {
				...
				case 27:
					if (
						...
						(e = pe.current),
							Ki(t) ? Wi(t, e) : ((e = ff(a, r, n)), (t.stateNode = e), Fc(t));
					}
					return H(t), null;
				case 5:
				...
				case 4:
					return ve(), e === null && Sd(t.stateNode.containerInfo), H(t), null;
				case 10:
					return ea(t.type), H(t), null;
				case 19:
					if ((fe(F), (r = t.memoizedState), r === null)) return H(t), null;
									...
									try {
										if (((o = l.stateNode), a))
											...
											var f = l.memoizedProps.style,
												p =
													f != null && Object.hasOwn(f, `display`)
														? f.display
														: null;
											c.style.display =
		...
		var Rl = {
			...
			fu = null;
		function pu() {
			return G & 2 && J !== 0 ? J & -J : O.T === null ? dt() : dd();
		}
		function mu() {
			if (Jl === 0)
				if (!(J & 536870912) || P) {
		...
		function Nu(e) {
			...
			switch (t.tag) {
				...
				case 5:
					Mo(t);
				default:
					Hc(n, t), (t = q = _i(t, Wl)), (t = Pc(n, t, Wl));
			}
			(e.memoizedProps = e.pendingProps), t === null ? Fu(e) : (q = t);
		}
		function Pu(e, t, n, r) {
			...
			switch (t) {
				...
				case `select`:
					...
					for (a in r)
						if (
							((o = r[a]),
							(l = n[a]),
							Object.hasOwn(r, a) && (o != null || l != null))
						)
							switch (a) {
								case `value`:
									p = o;
				...
				case `textarea`:
					for (c in ((m = p = null), n))
						if (
							((a = n[c]),
							Object.hasOwn(n, c) && a != null && !Object.hasOwn(r, c))
						)
							switch (c) {
								case `value`:
									break;
					...
					for (s in r)
						if (
							((a = r[s]),
							(o = n[s]),
							Object.hasOwn(r, s) && (a != null || o != null))
						)
							switch (s) {
								case `value`:
									p = a;
				...
				case `option`:
					for (var h in n)
						if (
							((p = n[h]),
							Object.hasOwn(n, h) && p != null && !Object.hasOwn(r, h))
						)
							switch (h) {
								case `selected`:
									e.selected = !1;
					...
					for (l in r)
						if (
							((p = r[l]),
							(m = n[l]),
							Object.hasOwn(r, l) && p !== m && (p != null || m != null))
						)
							switch (l) {
								case `selected`:
									e.selected =
				...
				case `menuitem`:
					...
					for (u in r)
						if (
							((p = r[u]),
							(m = n[u]),
							Object.hasOwn(r, u) && p !== m && (p != null || m != null))
						)
							switch (u) {
								case `children`:
								case `dangerouslySetInnerHTML`:
...
function ie(e, t, n, r = {}) {
	...
	function f(e, t) {
		s = `PUSH`;
		const r = S(e) ? e : te(h.location, e, t);
		n && n(r, e), (l = u() + 1);
		const d = D(r, l),
...
function se(e, t, n, r, i) {
	const a = Ce((typeof t == `string` ? re(t) : t).pathname || `/`, n);
	if (a == null) return null;
	let o = i ?? k(e),
		s = null,
		c = Se(a);
	for (let e = 0; s == null && e < o.length; ++e) s = ye(o[e], c, r);
	return s;
}
function O(e, t) {
	const { route: n, pathname: r, params: i } = e;
	return {
		id: n.id,
		pathname: r,
		params: i,
...
function ce(e, t = [], n = [], r = ``, i = !1) {
	...
	return (
		e.forEach((e, t) => {
			...
			else for (const n of le(e.path)) a(e, t, !0, n);
		}),
		t
	);
}
...
function _e(e, t) {
	...
	return (
		...
		n
			.filter((e) => !ge(e))
			.reduce((e, t) => e + (de.test(t) ? fe : t === `` ? pe : me), r)
	);
}
function ve(e, t) {
	...
	for (let e = 0; e < r.length; ++e) {
		...
		Object.assign(i, u.params),
			o.push({
				...
				pathnameBase: Pe(Me([a, u.pathnameBase])),
				route: d,
			}),
...
function be(e, t) {
	...
	const [n, r] = xe(e.path, e.caseSensitive, e.end),
		i = t.match(n);
	if (!i) return null;
	let a = i[0],
		o = a.replace(/(.)\/+$/, `$1`),
...
function Te(e, t = `/`) {
	...
	return (
		n
			? ((n = je(n)),
				(a = n.startsWith(`/`) ? Ee(n.substring(1), `/`) : Ee(n, t)))
			: (a = t),
		{ pathname: a, search: Fe(r), hash: Ie(i) }
	);
}
function Ee(e, t) {
	const n = Ne(t).split(`/`);
	...
	typeof e == `string`
		...
		: ((i = { ...e }),
			w(
				...
				De(`?`, `pathname`, `search`, i),
			),
			w(
				!i.pathname || !i.pathname.includes(`#`),
				De(`#`, `pathname`, `hash`, i),
			),
			w(!i.search || !i.search.includes(`#`), De(`#`, `search`, `hash`, i)));
	let a = e === `` || i.pathname === ``,
		o = a ? `/` : i.pathname,
		s;
	if (o == null) s = n;
...
function ze(e) {
	return Me(e.map((e) => e.route.path).filter(Boolean)) || `/`;
}
var Be =
	typeof window < `u` &&
	window.document !== void 0 &&
...
var Ge = x.createContext(null);
Ge.displayName = `DataRouterState`;
var Ke = x.createContext(!1);
function qe() {
	return x.useContext(Ke);
}
var Je = x.createContext({ isTransitioning: !1 });
Je.displayName = `ViewTransition`;
var Ye = x.createContext(new Map());
...
function it(e) {
	if (e.startsWith(`${tt}:${nt}:{`))
		try {
			const t = JSON.parse(e.slice(28));
			if (
				typeof t == `object` &&
				t &&
...
function at(e) {
	if (e.startsWith(`${tt}:${rt}:{`))
		try {
			const t = JSON.parse(e.slice(40));
			if (
				typeof t == `object` &&
				t &&
				typeof t.status == `number` &&
...
function ot(e, { relative: t } = {}) {
	w(st(), `useHref() may be used only in the context of a <Router> component.`);
	let { basename: n, navigator: r } = x.useContext(Ze),
		{ hash: i, pathname: a, search: o } = pt(e, { relative: t }),
		s = a;
	return (
		n !== `/` && (s = a === `/` ? n : Me([n, a])),
...
function ct() {
	return (
		...
		x.useContext(Qe).location
	);
}
var lt = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function ut(e) {
	x.useContext(Ze).static || x.useLayoutEffect(e);
}
function dt() {
	const { isDataRoute: e } = x.useContext($e);
	return e ? jt() : ft();
}
function ft() {
	w(
	...
	const e = x.useContext(We),
		{ basename: t, navigator: n } = x.useContext(Ze),
		{ matches: r } = x.useContext($e),
		{ pathname: i } = ct(),
		a = JSON.stringify(ke(r)),
		o = x.useRef(!1);
	return (
		ut(() => {
			o.current = !0;
		...
		x.useCallback(
			(r, s = {}) => {
				if ((T(o.current, lt), !o.current)) return;
				if (typeof r == `number`) {
					n.go(r);
					return;
				}
				const c = Ae(r, JSON.parse(a), i, s.relative === `path`);
				e == null &&
					t !== `/` &&
...
function pt(e, { relative: t } = {}) {
	const { matches: n } = x.useContext($e),
		{ pathname: r } = ct(),
		i = JSON.stringify(ke(n));
	return x.useMemo(() => Ae(e, JSON.parse(i), r, t === `path`), [e, i, r, t]);
}
function mt(e, t) {
	return ht(e, t);
}
function ht(e, t, n) {
	...
	const { navigator: r } = x.useContext(Ze),
		{ matches: i } = x.useContext($e),
		a = i[i.length - 1],
		o = a ? a.params : {},
		s = a ? a.pathname : `/`,
		c = a ? a.pathnameBase : `/`,
...
var _t = x.createElement(gt, null),
	vt = class extends x.Component {
		constructor(e) {
			super(e),
				(this.state = {
					location: e.location,
			...
			const t =
				e === void 0
					...
					: x.createElement(
							...
							x.createElement(et.Provider, {
								value: e,
								children: this.props.component,
							}),
						);
			return this.context ? x.createElement(bt, { error: e }, t) : t;
		}
	};
vt.contextType = Ke;
var yt = new WeakMap();
function bt({ children: e, error: t }) {
	const { basename: n } = x.useContext(Ze);
	if (
		typeof t == `object` &&
		t &&
		`digest` in t &&
...
function xt({ routeContext: e, match: t, children: n }) {
	...
	return (
		...
		x.createElement($e.Provider, { value: e }, n)
	);
}
function St(e, t = [], n) {
	const r = n?.state;
	...
	let i = e,
		a = r?.errors;
	if (a != null) {
		const e = i.findIndex((e) => e.route.id && a?.[e.route.id] !== void 0);
		w(
			e >= 0,
	...
	if (n && r) {
		...
		for (let e = 0; e < i.length; e++) {
			...
			if (
				...
				const { loaderData: e, errors: a } = r,
					c =
						t.route.loader &&
						!Object.hasOwn(e, t.route.id) &&
	...
	return i.reduceRight((e, n, c) => {
		...
		const m = t.concat(i.slice(0, c + 1)),
			h = () => {
				let t;
				return (
					(t = u
...
function Ot() {
	return Tt(`useNavigation`).navigation;
}
function kt() {
	const { matches: e, loaderData: t } = Tt(`useMatches`);
	return x.useMemo(() => e.map((e) => O(e, t)), [e, t]);
}
function At() {
	const e = x.useContext(et),
		t = Tt(`useRouteError`),
		n = j(`useRouteError`);
	return e === void 0 ? t.errors?.[n] : e;
}
function jt() {
	const { router: e } = wt(`useNavigate`),
		t = j(`useNavigate`),
		n = x.useRef(!1);
	return (
		ut(() => {
	...
	return (
		...
		h == null
			...
			: x.createElement(
					Ze.Provider,
					{ value: c },
					x.createElement(Qe.Provider, { children: t, value: h }),
				)
	);
}
	...
	return (
		x.Children.forEach(e, (e, r) => {
			...
			if (e.type === x.Fragment) {
				n.push.apply(n, Rt(e.props.children, i));
				return;
			}
			w(
				e.type === Ft,
			...
			e.props.children && (a.children = Rt(e.props.children, i)), n.push(a);
		}),
		n
	);
}
...
function Kt(e, t) {
	return e.button === 0 && (!t || t === `_self`) && !Gt(e);
}
var qt = null;
function Jt() {
	if (qt === null)
...
function Xt(e) {
	return e != null && !Yt.has(e)
		? (T(
				!1,
				`"${e}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Bt}"`,
			),
			null)
		: e;
}
function Zt(e, t) {
	...
	if (Ut(e)) {
		...
		(r = o ? Ce(o, t) : null),
			(n = e.getAttribute(`method`) || zt),
			(i = Xt(e.getAttribute(`enctype`)) || Bt),
			(a = new FormData(e));
	} else if (Ht(e) || (Wt(e) && (e.type === `submit` || e.type === `image`))) {
		const o = e.form;
		if (o == null)
			throw Error(
				`Cannot submit a <button> or <input type="submit"> without a <form>`,
			);
		const s = e.getAttribute(`formaction`) || o.getAttribute(`action`);
		if (
			((r = s ? Ce(s, t) : null),
			(n = e.getAttribute(`formmethod`) || o.getAttribute(`method`) || zt),
			(i =
				Xt(e.getAttribute(`formenctype`)) ||
				Xt(o.getAttribute(`enctype`)) ||
				Bt),
			(a = new FormData(o, e)),
			!Jt())
		) {
			const { name: t, type: n, value: r } = e;
			if (n === `image`) {
				const e = t ? `${t}.` : ``;
	...
	return (
		n
			...
			: i.pathname === `/`
				? (i.pathname = `_root.${r}`)
				: t && Ce(i.pathname, t) === `/`
					? (i.pathname = `${Ne(t)}/_root.${r}`)
					: (i.pathname = `${Ne(i.pathname)}.${r}`),
		i
	);
}
async function rn(e, t) {
	...
	try {
		const n = await b(() => import(e.module), []);
		return (t[e.id] = n), n;
	} catch (t) {
		return (
			console.error(
...
async function sn(e, t, n) {
	return fn(
		(
			await Promise.all(
				e.map(async (e) => {
					const r = t.routes[e.route.id];
					if (r) {
						const e = await rn(r, n);
...
function cn(e, t, n, r, i, a) {
	const o = (e, t) => (n[t] ? e.route.id !== n[t].route.id : !0),
		s = (e, t) =>
	...
	return a === `assets`
		...
		: a === `data`
			? t.filter((t, a) => {
					const c = r.routes[t.route.id];
					if (!c || !c.hasLoader) return !1;
					if (o(t, a) || s(t, a)) return !0;
					if (t.route.shouldRevalidate) {
						const r = t.route.shouldRevalidate({
							currentUrl: new URL(
...
function ln(e, t, { includeHydrateFallback: n } = {}) {
	return un(
		e.flatMap((e) => {
			const r = t.routes[e.route.id];
			if (!r) return [];
...
var hn = x.createContext(void 0);
hn.displayName = `FrameworkContext`;
function gn() {
	const e = x.useContext(hn);
	return (
		tn(e, `You must render this element inside a <HydratedRouter> element`), e
	);
}
function _n(e, t) {
	const n = x.useContext(hn),
		[r, i] = x.useState(!1),
		[a, o] = x.useState(!1),
		{
			onFocus: s,
...
function yn({ page: e, ...t }) {
	...
	return i
		? n
			...
			: x.createElement(Sn, { page: e, matches: i, ...t })
		: null;
}
function bn(e) {
	const { manifest: t, routeModules: n } = gn(),
		[r, i] = x.useState([]);
	return (
		x.useEffect(() => {
			let r = !1;
...
function xn({ page: e, matches: t, ...n }) {
	const r = ct(),
		...
		o = x.useMemo(() => {
			...
			let n = nn(e, a, i.unstable_trailingSlashAwareDataRequests, `rsc`),
				o = !1,
				s = [];
			for (const e of t)
...
function Sn({ page: e, matches: t, ...n }) {
	const r = ct(),
		{ future: i, manifest: a, routeModules: o } = gn(),
		{ basename: s } = pn(),
		{ loaderData: c, matches: l } = mn(),
		u = x.useMemo(() => cn(e, t, l, a, r, `data`), [e, t, l, a, r]),
		d = x.useMemo(() => cn(e, t, l, a, r, `assets`), [e, t, l, a, r]),
		f = x.useMemo(() => {
			if (e === r.pathname + r.search + r.hash) return [];
			let n = new Set(),
				l = !1;
			if (
				...
				return [];
			const d = nn(e, s, i.unstable_trailingSlashAwareDataRequests, `data`);
			return (
				l &&
					n.size > 0 &&
					d.searchParams.set(
...
var wn =
	...
	window.document.createElement !== void 0;
try {
	wn && (window.__reactRouterVersion = `7.15.0`);
} catch {}
function Tn({ basename: e, children: t, useTransitions: n, window: r }) {
	const i = x.useRef();
	i.current ??= C({ window: r, v5Compat: !0 });
	const a = i.current,
...
function En({ basename: e, children: t, history: n, useTransitions: r }) {
	const [i, a] = x.useState({ action: n.action, location: n.location }),
		o = x.useCallback(
			(e) => {
...
En.displayName = `unstable_HistoryRouter`;
var Dn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
	On = x.forwardRef(
		(
			{
			...
			const { basename: h, navigator: g, useTransitions: _ } = x.useContext(Ze),
				v = typeof l == `string` && Dn.test(l),
				y = Ve(l, h);
			l = y.to;
			let b = ot(l, { relative: r }),
				ee = ct(),
				S = null;
			if (o) {
				const e = Ae(o, [], ee.mask ? ee.mask.pathname : `/`, !0);
				h !== `/` &&
					(e.pathname = e.pathname === `/` ? h : Me([h, e.pathname])),
					(S = g.createHref(e));
			}
			const [C, w, T] = _n(n, p),
				E = Fn(l, {
			...
			const te = !(y.isExternal || i),
				ne = x.createElement(`a`, {
					...p,
					...T,
					href: (te ? S : void 0) || y.absoluteURL || b,
					onClick: te ? D : e,
					ref: Cn(m, w),
					target: c,
...
var kn = x.forwardRef(
	(
		...
		let u = pt(a, { relative: c.relative }),
			d = ct(),
			f = x.useContext(Ge),
			{ navigator: p, basename: m } = x.useContext(Ze),
			h = f != null && Gn(u) && o === !0,
		...
		w =
			typeof n == `function`
				...
				: [
						...
						.filter(Boolean)
						.join(` `);
		const T = typeof i == `function` ? i(S) : i;
		return x.createElement(
			On,
			{
				...c,
...
var An = x.forwardRef(
	(
		...
		const { useTransitions: h } = x.useContext(Ze),
			g = Rn(),
			_ = zn(s, { relative: l }),
			v = o.toLowerCase() === `get` ? `get` : `post`,
			y = typeof s == `string` && Dn.test(s);
		return x.createElement(`form`, {
			...
			onSubmit: r
				...
				: (e) => {
						...
						e.preventDefault();
						const r = e.nativeEvent.submitter,
...
An.displayName = `Form`;
function jn({ getKey: e, storageKey: t, ...n }) {
	const r = x.useContext(hn),
		{ basename: i } = x.useContext(Ze),
		a = ct(),
		o = kt();
	Un({ getKey: e, storageKey: t });
	const s = x.useMemo(() => {
		if (!r || !e) return null;
		const t = Hn(a, o, i, e);
	...
	const c = ((e, t) => {
		if (!window.history.state || !window.history.state.key) {
			const e = Math.random().toString(32).slice(2);
	...
	return x.createElement(`script`, {
		...
		dangerouslySetInnerHTML: {
			__html: `(${c})(${en(JSON.stringify(t || Bn))}, ${en(JSON.stringify(s))})`,
		},
	});
}
jn.displayName = `ScrollRestoration`;
function Mn(e) {
	return `${e} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`;
}
function Nn(e) {
...
var In = 0,
	Ln = () => `__${String(++In)}__`;
function Rn() {
	const { router: e } = Nn(`useSubmit`),
		{ basename: t } = x.useContext(Ze),
		n = Dt(),
		r = e.fetch,
		i = e.navigate;
	return x.useCallback(
		async (e, a = {}) => {
			...
			a.navigate === !1
				? await r(a.fetcherKey || Ln(), n, a.action || o, {
...
var Bn = `react-router-scroll-positions`,
	Vn = {};
function Hn(e, t, n, r) {
	let i = null;
	return (
...
function Un({ getKey: e, storageKey: t } = {}) {
	const { router: n } = Nn(`useScrollRestoration`),
		{ restoreScrollPosition: r, preventScrollReset: i } =
			Pn(`useScrollRestoration`),
		{ basename: a } = x.useContext(Ze),
		o = ct(),
		s = kt(),
		c = Ot();
	x.useEffect(
		...
		Wn(
			x.useCallback(() => {
				...
				try {
					sessionStorage.setItem(t || Bn, JSON.stringify(Vn));
				} catch (e) {
					T(
						!1,
		...
		typeof document < `u` &&
			(x.useLayoutEffect(() => {
				try {
					const e = sessionStorage.getItem(t || Bn);
					e && (Vn = JSON.parse(e));
				} catch {}
			}, [t]),
			x.useLayoutEffect(() => {
				const t = n?.enableScrollRestoration(
					Vn,
					() => window.scrollY,
					e ? (t, n) => Hn(t, n, a, e) : void 0,
				);
				return () => t && t();
			}, [n, a, e]),
			x.useLayoutEffect(() => {
...
function Wn(e, t) {
	const { capture: n } = t || {};
	x.useEffect(() => {
		const t = n == null ? void 0 : { capture: n };
		return (
...
function Gn(e, { relative: t } = {}) {
	...
	const { basename: r } = Nn(`useViewTransitionState`),
		i = pt(e, { relative: t });
	if (!n.isTransitioning) return !1;
	const a = Ce(n.currentLocation.pathname, r) || n.currentLocation.pathname,
...
var Kn = o((e) => {
	...
	Jn = c(g(), 1),
	M = qn(),
	Yn = { Pixel: `Pixel`, Percent: `Percent` },
	Xn = { unit: Yn.Percent, value: 80 };
function Zn(e) {
	return typeof e == `number`
		? { unit: Yn.Percent, value: e * 100 }
		: typeof e == `string`
			? /^(\d*(\.\d+)?)px$/.exec(e)
				? { unit: Yn.Pixel, value: parseFloat(e) }
				: /^(\d*(\.\d+)?)%$/.exec(e)
					? { unit: Yn.Percent, value: parseFloat(e) }
					: (console.warn(
							`scrollThreshold format is invalid. Valid formats: "120px", "50%"...`,
						),
						Xn)
			: (console.warn(`scrollThreshold should be string or number`), Xn);
}
function Qn(e, t) {
	let n = Zn(e),
		r;
	return (
		(r = n.unit === Yn.Pixel ? `${n.value}px` : `${100 - n.value}%`),
		t ? `${r} 0px 0px 0px` : `0px 0px ${r} 0px`
	);
}
function $n({
	next: e,
	...
	pullDownToRefreshThreshold: m = 100,
	refreshFunction: h,
	onScroll: g,
	dataLength: _,
	initialScrollY: v,
	...
	const [b, ee] = (0, x.useState)(!1),
		...
		ne = (0, x.useRef)(e);
	ne.current = e;
	const re = (0, x.useRef)(h);
	re.current = h;
	const ie = (0, x.useRef)(m);
	ie.current = m;
	const ae = (0, x.useRef)(!1),
		oe = (0, x.useRef)(!1),
		se = (0, x.useRef)(0),
		O = (0, x.useRef)(0),
		k = (0, x.useRef)(0),
	...
	(0, x.useEffect)(() => {
		...
		if (d && typeof h != `function`)
			throw Error(`Mandatory prop "refreshFunction" missing.
          Pull Down To Refresh functionality will not work
          as expected. Check README.md for usage'`);
		if (typeof v == `number`) {
			const e = s ? E.current : ce();
			e && e.scrollHeight > v && e.scrollTo(0, v);
		}
	}, []),
		(0, x.useEffect)(() => {
			(ae.current = !1), ee(!1);
		...
		(0, x.useEffect)(() => {
			...
			const e = D.current;
			if (!e) return;
			const n = s ? E.current : ce(),
				r = new IntersectionObserver(
					([e]) => {
						!e.isIntersecting ||
							ae.current ||
							((ae.current = !0), ee(!0), ne.current());
					},
					{ root: n, rootMargin: Qn(i, u), threshold: 0 },
				);
			return r.observe(e), () => r.disconnect();
		}, [t, i, u, s, ce]),
		(0, x.useEffect)(() => {
			if (!g) return;
			const e = (s ? E.current : ce()) ?? (typeof window < `u` ? window : null);
			if (!e) return;
			const t = (e) => {
				setTimeout(() => g(e), 0);
			};
		...
		(0, x.useEffect)(() => {
			...
			const e = (s ? E.current : ce()) ?? (typeof window < `u` ? window : null);
			if (!e) return;
			if (te.current?.firstChild) {
				const e = te.current.firstChild.getBoundingClientRect().height;
				(k.current = e), T(e);
			}
			const t = (t) => {
					(e instanceof HTMLElement
						...
						t instanceof MouseEvent
							? (se.current = t.pageY)
							: t instanceof TouchEvent && (se.current = t.touches[0].pageY),
						(O.current = se.current),
						E.current &&
							((E.current.style.willChange = `transform`),
							(E.current.style.transition = `transform 0.2s cubic-bezier(0,0,0.31,1)`)));
				},
				n = (e) => {
					if (
						!oe.current ||
						(e instanceof MouseEvent
							? (O.current = e.pageY)
							: e instanceof TouchEvent && (O.current = e.touches[0].pageY),
						O.current < se.current)
					)
						return;
					const t = O.current - se.current;
					t >= ie.current && C(!0),
						!(t > k.current * 1.5) &&
							E.current &&
							((E.current.style.overflow = `visible`),
							(E.current.style.transform = `translate3d(0px, ${t}px, 0px)`));
				},
				r = () => {
					(se.current = 0),
						(O.current = 0),
						...
						C((e) => {
							var t;
							return e && ((t = re.current) == null || t.call(re)), !1;
						}),
						requestAnimationFrame(() => {
							E.current &&
								((E.current.style.overflow = `auto`),
								(E.current.style.transform = `none`),
								(E.current.style.willChange = `unset`));
						});
				};
			return (
	...
	const le = {
		...
		ue = l || !!(n && n instanceof Array && n.length),
		de = d && s ? { overflow: `auto` } : {},
		fe = t ? (0, M.jsx)(`div`, { ref: D, style: { height: 1 } }) : null;
	return (0, M.jsx)(`div`, {
		style: de,
		className: `infinite-scroll-component__outerdiv`,
		children: (0, M.jsxs)(`div`, {
			className: [`infinite-scroll-component`, y].filter(Boolean).join(` `),
			ref: E,
			style: le,
			children: [
				d &&
					(0, M.jsx)(`div`, {
						...
						children: (0, M.jsx)(`div`, {
							style: { position: `absolute`, left: 0, right: 0, top: -1 * w },
							children: S ? p : f,
						}),
					}),
				n,
...
function er() {
	const [e, t] = (0, x.useState)([]),
		[n, r] = (0, x.useState)(!0),
		[i, a] = (0, x.useState)(null);
	return (0, M.jsxs)(`div`, {
		className: `page`,
		children: [
			(0, M.jsx)(`h2`, { children: `Aktuellt` }),
			(0, M.jsx)(`p`, { children: `Aktuella polishändelser i Sverige` }),
			(0, M.jsx)($n, {
				...
				next: async () => {
					const n = await (
						await fetch(
							`${window.location.origin}/CRUD/current_events?offset=${e.length}`,
						)
					).json();
					if (n.length === 0) {
						r(!1);
				...
				loader: (0, M.jsx)(`p`, {
					...
					children: `Laddar händelser...`,
				}),
				endMessage: (0, M.jsx)(`p`, {
					style: { textAlign: `center` },
					children: `Inga händelser hittades.`,
				}),
					...
					(0, M.jsxs)(
						`article`,
						{
							...
							children: [
								...
								(0, M.jsx)(`h4`, { children: e.summary }),
								(0, M.jsx)(`p`, { children: e.location?.name }),
								(0, M.jsx)(`p`, {
			...
			i &&
				(0, M.jsx)(`div`, {
					...
					children: (0, M.jsxs)(`div`, {
						...
						children: [
							(0, M.jsx)(`span`, { className: `card-pill`, children: i.type }),
							(0, M.jsx)(`h3`, { children: i.summary }),
							(0, M.jsxs)(`p`, {
								children: [
									i.location?.name,
									` — `,
							...
							i.location?.gps &&
								(0, M.jsx)(`iframe`, {
									...
									src: `https://maps.google.com/maps?q=${i.location.gps}&z=13&output=embed`,
								}),
							(0, M.jsx)(`button`, {
...
function tr() {
	...
	return (0, M.jsxs)(`div`, {
		className: `page`,
		children: [
			(0, M.jsx)(`h2`, { children: `Arkiv` }),
			(0, M.jsx)(`p`, { children: `Arkiverade polishändelser i Sverige` }),
			(0, M.jsx)($n, {
				className: `card-grid feed-grid`,
				dataLength: e.length,
				next: async () => {
					const n = await (
						await fetch(
							`${window.location.origin}/CRUD/archived_events?offset=${e.length}`,
						)
					).json();
					if (n.length === 0) {
						r(!1);
...
function rr() {
	return (0, M.jsxs)(`div`, {
		className: `page`,
		children: [
			(0, M.jsx)(`h2`, { children: `About Us` }),
			(0, M.jsx)(`p`, {
				children: `Här är information om teamet bakom Police Event Tracker.`,
			}),
			(0, M.jsx)(`div`, {
				className: `team-grid`,
				children: nr.map((e) =>
					(0, M.jsxs)(
						`div`,
						{
							...
							children: [
								...
								(0, M.jsx)(`p`, { children: e.info }),
								(0, M.jsx)(`a`, { href: `mailto:${e.mail}`, children: e.mail }),
							],
						},
						e.name,
					),
...
function ir() {
	...
	return (0, M.jsxs)(`div`, {
		className: `page`,
		children: [
			(0, M.jsx)(`h2`, { children: `Mina sidor` }),
			(0, M.jsx)(`p`, { children: `Din profil och dina inställningar` }),
			(0, M.jsxs)(`div`, {
				className: `team-grid`,
				children: [
					(0, M.jsxs)(`div`, {
						className: `team-card`,
						children: [
							(0, M.jsx)(`h3`, { children: `Min information` }),
							(0, M.jsx)(`span`, {
								className: `team-role`,
								children: `Profil`,
							}),
							(0, M.jsxs)(`p`, { children: [`Namn: `, e.name] }),
							(0, M.jsxs)(`p`, { children: [`Telefon: `, e.phone] }),
							(0, M.jsxs)(`p`, { children: [`Adress: `, e.address] }),
							(0, M.jsxs)(`p`, { children: [`Email: `, e.email] }),
						],
					}),
					(0, M.jsxs)(`div`, {
						className: `team-card`,
						children: [
							(0, M.jsx)(`h3`, { children: `Kommentarer` }),
							(0, M.jsx)(`span`, {
								className: `team-role`,
								children: `Aktivitet`,
							}),
							t.length === 0
								? (0, M.jsx)(`p`, { children: `Inga kommentarer ännu.` })
								: t.map((e, t) => (0, M.jsx)(`p`, { children: e }, t)),
						],
					}),
					(0, M.jsxs)(`div`, {
						className: `team-card`,
						children: [
							(0, M.jsx)(`h3`, { children: `Sparade händelser` }),
							(0, M.jsx)(`span`, {
								className: `team-role`,
								children: `Sparade`,
							}),
							n.length === 0
								? (0, M.jsx)(`p`, { children: `Inga sparade händelser ännu.` })
								: n.map((e, t) => (0, M.jsx)(`p`, { children: e }, t)),
						],
					}),
				],
			}),
...
function ar() {
	return (0, M.jsxs)(`div`, {
		className: `page`,
		children: [
			(0, M.jsx)(`h2`, { children: ` Admin` }),
			(0, M.jsx)(`p`, { children: ` endast för admin där man kan se saker` }),
		],
	});
}
function or({ onClose: e }) {
	const [t, n] = (0, x.useState)(!1),
		[r, i] = (0, x.useState)(``),
		[a, o] = (0, x.useState)(``),
		[s, c] = (0, x.useState)(``),
		[l, u] = (0, x.useState)(``);
	return (0, M.jsx)(`div`, {
		...
		children: (0, M.jsxs)(`div`, {
			...
			onClick: (e) => e.stopPropagation(),
			children: [
				(0, M.jsx)(`h3`, { children: t ? `Registrera dig` : `Logga in` }),
				t &&
					(0, M.jsx)(`input`, {
				...
				(0, M.jsxs)(`div`, {
					...
					children: [
						(0, M.jsx)(`button`, {
							className: `modal-close`,
							onClick: () => n(!t),
							children: t ? `Har konto? Logga in` : `Registrera dig`,
						}),
						(0, M.jsx)(`button`, {
							className: `modal-close`,
							onClick: async () => {
								...
								const i = await fetch(
									...
									o = await i.json();
								if (!i.ok) {
									alert(o.message || `Något gick fel`);
									return;
								}
								o.token
									...
									: o.message === `Registered`
										? (alert(`Registrerad! Logga in nu.`), n(!1))
										: alert(o.message);
							},
							children: t ? `Registrera` : `Logga in`,
						}),
					],
				}),
				(0, M.jsx)(`button`, {
					className: `modal-close login-close`,
					onClick: e,
					children: `Stäng`,
				}),
			],
...
var sr = `/assets/person-DjepFPTO.png`,
	cr = `/assets/list-B1lwyFUu.png`,
	lr = !1,
	ur = [
		{
			title: `Om oss`,
		...
		children: [
			(0, M.jsxs)(`div`, {
				...
				children: [
					...
					(0, M.jsx)(`main`, {
						id: `main-content`,
						children: (0, M.jsxs)(Lt, {
							children: [
								(0, M.jsx)(Ft, {
									path: `/`,
									element: (0, M.jsxs)(M.Fragment, {
										children: [
											(0, M.jsxs)(`section`, {
												...
												children: [
													(0, M.jsx)(`p`, {
														className: `hero-tag`,
														children: ` Polishändelser`,
													}),
													(0, M.jsx)(`h2`, {
														children: `Aktuella händelser i Sverige`,
													}),
													(0, M.jsx)(`p`, {
														className: `hero-text`,
														children: `Här kan du följa aktuella polishändelser runt om i Sverige, inklusive brott, olyckor, nödsituationer och deras platser.`,
													}),
												],
											}),
											(0, M.jsxs)(`section`, {
												...
												children: [
													(0, M.jsxs)(`div`, {
														...
														children: [
															(0, M.jsx)(`p`, { children: `Info` }),
															(0, M.jsx)(`h3`, { children: `Om sidan` }),
														],
													}),
													(0, M.jsx)(`div`, {
														className: `card-grid featured-grid`,
														children: ur.map((e) =>
															(0, M.jsx)(
																On,
																{
																	...
																	children: (0, M.jsxs)(`article`, {
																		...
																		children: [
																			...
																			(0, M.jsx)(`h4`, { children: e.title }),
																			(0, M.jsx)(`p`, { children: e.text }),
																		],
																	}),
																},
																e.title,
								...
								(0, M.jsx)(Ft, { path: `/arkiv`, element: (0, M.jsx)(tr, {}) }),
								(0, M.jsx)(Ft, {
									path: `/about-us`,
									element: (0, M.jsx)(rr, {}),
								}),
								...
								(0, M.jsx)(Ft, { path: `/admin`, element: (0, M.jsx)(ar, {}) }),
							],
						}),
					}),
					(0, M.jsxs)(`footer`, {
						...
						children: [
							(0, M.jsx)(`p`, { children: `2026 Police Event Tracker` }),
							(0, M.jsx)(`p`, { children: `Kontakt` }),
						],
					}),
				],
			}),
			n && (0, M.jsx)(or, { onClose: () => r(!1) }),
		],
	});
}
Jn.createRoot(document.getElementById(`root`)).render(
	(0, M.jsx)(x.StrictMode, { children: (0, M.jsx)(dr, {}) }),
);
